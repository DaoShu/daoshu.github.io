(function(a){
    a.fn.html5_3d_animation=function(p){
        ...
        var w_w=p&&p.window_width?p.window_width:document.documentElement.clientWidth;
        var w_h=p&&p.window_height?p.window_height:document.documentElement.clientHeight;
        ...
        function setup()
        {
            ...
            {
                /*c.fillStyle=w_b;
                c.arc(0,0,10,d2a(0),d2a(360),false);
                c.fill();*/
                c.fillStyle=w_b;
